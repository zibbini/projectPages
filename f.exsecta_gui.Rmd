...
## A simple GUI for exploring individual nest characteristics
...
bscols(widths = c(3,9),
       ...
       #Inputs =================
       list(
         filter_select("cmpt", "Reserve location:", dfmap, ~compartment),
